...
$edit_query = "SELECT * FROM produits WHERE product_id = $prduct_id ";
...
if (isset($_POST['edit_product'])) {
    ...
    $query = "UPDATE produits SET product_title = '$product_title' ,product_image ='$product_image', product_desc = '$product_desc', product_info = '$product_info', product_price = '$product_price'  WHERE product_id = $p_id ";
